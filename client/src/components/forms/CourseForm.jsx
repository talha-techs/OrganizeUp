...
const CourseForm = ({ course, onClose }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label className="block text-sm font-medium text-secondary mb-1.5">Course Name *</label>
        <input
          type="text"
      ...
      <div>
        <label className="block text-sm font-medium text-secondary mb-1.5">Drive Link</label>
        <input
          type="url"
