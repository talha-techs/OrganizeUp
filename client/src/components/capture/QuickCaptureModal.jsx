...
const QuickCaptureModal = () => {
  ...
  const renderDetectedIcon = () => {
    ...
    if (scrapedData?.platform === 'linkedin' || /linkedin\.com/i.test(url)) {
      return <FaLinkedin className="text-sky-500" size={18} />;
    }
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-muted">
                  Unified inbox for Reels, WhatsApp messages, images & web clips
                </p>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    {url && (
                      ...
                      >
                        {scrapeLoading ? 'Inspecting...' : 'Preview'}
                      </button>
                    )}
                  </div>
                </div>
                  ...
                  >
                    {scrapedData.thumbnailUrl ? (
                      <img
                        ...
                        alt="Preview"
                        className="w-16 h-16 object-cover rounded-lg flex-shrink-0 bg-surface border border-subtle"
                      />
                    ) : (
                      <div className="w-16 h-16 rounded-lg bg-accent-subtle flex items-center justify-center text-accent flex-shrink-0">
                        {renderDetectedIcon()}
                      </div>
                    )}
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-1.5 mb-1">
                        <span className="text-[10px] uppercase font-bold tracking-wider px-1.5 py-0.5 rounded bg-surface border border-subtle text-accent">
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g. Next.js 15 tips from chat"
                      className="w-full px-3 py-2 rounded-xl bg-surface border border-subtle text-sm text-primary placeholder:text-muted focus:outline-none focus:border-emerald-500 transition-all"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Paste the forwarded WhatsApp message, recommendations, key insights, or link here..."
                    required
                ...
                {whatsappMessage && (
                  <div className="p-3 rounded-xl bg-emerald-950/20 border border-emerald-900/30">
                    ...
                    <div className="bg-emerald-900/40 text-emerald-100 p-3 rounded-2xl rounded-tl-none border border-emerald-700/40 max-w-md text-xs leading-relaxed">
                      ...
                      <div className="text-[9px] text-emerald-300/70 text-right mt-1.5 flex items-center justify-end gap-1">
                        <span>Just now</span>
                        <span>✓✓</span>
                      </div>
                    </div>
