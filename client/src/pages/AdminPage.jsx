...
const AdminPage = () => {
  ...
  const { stats, users, selectedUser, publishRequests, reviewResource, isLoading } =
    useSelector((state) => state.admin);
  const [view, setView] = useState('dashboard'); // dashboard | users | userDetail | publishRequests | requestDetail
